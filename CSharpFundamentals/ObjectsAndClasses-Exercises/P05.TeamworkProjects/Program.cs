...
using static P05.TeamworkProjects.Program;
    ...
    public class Program
    {
        ...
        static void JoinTeams(List<Team> teams)
        {
            ...
            while ((cmd = Console.ReadLine()) != "end of assignment")
            {
                ...
                string user = cmdArgs[0].Trim();
                string teamName = cmdArgs[1].Trim();
        ...
        static void InitializeTeams(List<Team> teams)
        {
            ...
            for (int i = 0; i < n; i++)
            {
                ...
                string creator = teamArgs[0].Trim();
                string teamName = teamArgs[1].Trim();
